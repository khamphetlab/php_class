...
(function (h) { "function" === typeof define && define.amd ? define(["jquery"], function (E) { return h(E, window, document) }) : "object" === typeof exports ? module.exports = function (E, G) { E || (E = window); G || (G = "undefined" !== typeof window ? require("jquery") : require("jquery")(E)); return h(G, E, E.document) } : h(jQuery, window, document) })(function (h, E, G, k) {
    function X(a) {
        ...
        var b = m.defaults.oLanguage, c = a.sZeroRecords; !a.sEmptyTable && (c && "ບໍ່ມີຂໍ້ມູນໃນຕາຕະລາງ" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable"); !a.sLoadingRecords && (c && "Loading..." === b.sLoadingRecords) && F(a, a, "sZeroRecords", "sLoadingRecords");
                                        ...
                                        b, c, d) { return this.iterator("column", function (e, f) { var g = e.aoPreSearchCols; if (a === k) return g[f].sSearch; e.oFeatures.bFilter && (h.extend(g[f], { sSearch: a + "", bRegex: null === b ? !1 : b, bSmart: null === c ? !0 : c, bCaseInsensitive: null === d ? !0 : d }), fa(e, e.oPreviousSearch, 1)) }) }); o("state()", function () { return this.context.length ? this.context[0].oSavedState : null }); o("state.clear()", function () { return this.iterator("table", function (a) { a.fnStateSaveCallback.call(a.oInstance, a, {}) }) }); o("state.loaded()", function () {
                                            ...
                                            { nTr: null, anCells: null, _aData: [], _aSortData: null, _aFilterData: null, _sFilterRow: null, _sRowStripe: "", src: null, idx: -1 }; m.models.oColumn = {
                                                ...
                                                sWidthOrig: null
                                                 ...
                                                 }, fnStateSaveParams: null, iStateDuration: 7200, iDeferLoading: null, iDisplayLength: 10, iDisplayStart: 0, iTabIndex: 0, oClasses: {}, oLanguage: { oAria: { sSortAscending: ": activate to sort column ascending", sSortDescending: ": activate to sort column descending" }, oPaginate: { sFirst: "First", sLast: "Last", sNext: "ຕໍ່ໄປ", sPrevious: "ກ່ອນໜ້າ" }, sEmptyTable: "ບໍ່ມີຂໍ້ມູນໃນຕາຕະລາງ", sInfo: "ສະແດງ _START_ ຫາ _END_ ຂອງ _TOTAL_ ທັງໝົດ", sInfoEmpty: "ສະແດງ 0 ຫາ 0 ຂອງ 0 ທັງໝົດ", sInfoFiltered: "(ຄັດຈາກທັງໝົດ _MAX_ ລາຍການ)", sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "ສະແດງ _MENU_ ລາຍການ", sLoadingRecords: "ກຳລັງໂຫລດ...", sProcessing: "ກຳລັງປະມວນຜົນ...", sSearch: "ຄົ້ນຫາ:", sSearchPlaceholder: "", sUrl: "", sZeroRecords: "ບໍ່ພົບລາຍການທີ່ຄົ້ນຫາ" }, oSearch: h.extend({}, m.models.oSearch), sAjaxDataProp: "data", sAjaxSource: null, sDom: "lfrtip", searchDelay: null, sPaginationType: "simple_numbers", sScrollX: "", sScrollXInner: "", sScrollY: "", sServerMethod: "GET", renderer: null, rowId: "DT_RowId" };
